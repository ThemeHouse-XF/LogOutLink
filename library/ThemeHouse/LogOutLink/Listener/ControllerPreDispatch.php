...
class ThemeHouse_LogOutLink_Listener_ControllerPreDispatch extends ThemeHouse_Listener_ControllerPreDispatch
{
    ...
    {
        $controllerPreDispatch = new ThemeHouse_LogOutLink_Listener_ControllerPreDispatch($controller, $action);
